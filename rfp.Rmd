...
subtitle: "Including visualisation"
...
![Data analysis - credit Hadley Wickham](./figure/Data_Analysis_Hadley_Wickham.png)
...
x <- readMSData(f, mode = "onDisk", centroided = c(FALSE, TRUE, TRUE))
```
The file `r basename(f)` is read in to create a *raw data* object called
`x`. The file contains `r length(x)` spectra of levels
...
```{r plotms, echo=FALSE, fig.width = 15, fig.height = 5}
...
- *Using HyperLOPIT to perform high-resolution mapping of the spatial
  proteome*
  ([10.1038/nprot.2017.026](https://www.nature.com/nprot/journal/v12/n6/full/nprot.2017.026.html))
- *A draft map of the mouse pluripotent stem cell spatial proteome*
  ([10.1038/ncomms9992](http://www.nature.com/ncomms/2016/160112/ncomms9992/abs/ncomms9992.html))
...
**Acknowledgements**: BBSRC and the Wellcome
Trust; [Kathryn Lilley](https://www.bioc.cam.ac.uk/people/uto/lilley)
(spatial proteomics); [Lisa Breckels](https://github.com/lmsimp/)
(spatial proteomics and package
development); [Sebastian Gibb](https://sgibb.github.io/)
and [Johannes Rainer](https://github.com/jotsetung/) (package
developement)
